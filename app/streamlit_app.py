...
#     st.session_state.processing_status = 'initial'
# if 'chunks' not in st.session_state:
#     st.session_state.chunks = None
# if 'index' not in st.session_state:
#     st.session_state.index = None

# if uploaded_file and st.session_state.processing_status == 'initial':
#     st.session_state.processing_status = 'processing'
#     with st.spinner("🔍 Processing document..."):
#         # Correctly passing the uploaded file to the parser
#         text, error = extract_text_from_file({uploaded_file.name: uploaded_file.getvalue()})

#         if error:
#             st.error(f"⚠️ {error}")
#             st.session_state.processing_status = 'initial' # Reset state to allow re-upload
#         else:
#             chunks = chunk_text(text)
...
# # ❓ Q&A Section
# # ────────────────────────
# if st.session_state.processing_status == 'processed':
#     st.subheader("💬 Ask a Question")
#     user_question = st.text_input("Enter your question here")
...
#         else:
#             with st.spinner("⏳ Analyzing document and generating answer..."):
#                 top_chunks = get_best_chunk(user_question, st.session_state.chunks, st.session_state.index)
#                 answer = generate_answer_from_chunks(top_chunks, user_question)
#             st.markdown("### 📚 Answer")
#             st.success(answer)
